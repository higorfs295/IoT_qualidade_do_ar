...
# Medidas do payload, na ordem do contrato. co2/tvoc sao inteiros; o restante,
# ponto flutuante (o contrato exige numero, nunca texto com unidade).
MEDIDAS = (
    "co2_ppm",
    "tvoc_ppb",
    "pm1_ugm3",
...
def validar_contrato(msg: dict) -> str | None:
    """
    Valida uma mensagem contra o schema v1.0.

    Retorna None se estiver conforme; caso contrario, uma descricao curta do
    primeiro erro encontrado (para telemetria de rejeicao no sink).
    """
    ...
    if msg.get("schema_version") != SCHEMA_VERSION:
        return f"schema_version inesperado: {msg.get('schema_version')}"
