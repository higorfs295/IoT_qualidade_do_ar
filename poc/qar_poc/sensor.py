...
class Dispositivo:
    ...
    def proxima_leitura(self, prob_degradar: float) -> dict:
        ...
        # Atividade 2, onde o gas era SAFE/UNSAFE).
        if sensor_status == "ERROR":
            gas_status = "UNKNOWN"
        else:
            inseguro = (
                (medidas["co2_ppm"] is not None and medidas["co2_ppm"] > 1000)
                or (medidas["tvoc_ppb"] is not None and medidas["tvoc_ppb"] > 500)
